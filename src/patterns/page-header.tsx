...
export function PageHeader({ eyebrow, heading, description, breadcrumb, actions, className, ...props }: PageHeaderProps) {
  return (
    <header className={cn("p-pattern-page-header", className)} {...props}>
      <div className="p-pattern-page-header-copy">
        ...
        <h1 className="p-pattern-page-header-title">{heading}</h1>
